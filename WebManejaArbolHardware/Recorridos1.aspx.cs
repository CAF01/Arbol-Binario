...
{
    public partial class Recorridos1 : System.Web.UI.Page
    {
        Negocios Negocios;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["Negocios"] != null)
            {
                ...
                this.MostrarRecorrido(this.Negocios.MostrarComponentesPorOrden(Transversa.InOrder), g, bitmap.Width, bitmap.Height);
